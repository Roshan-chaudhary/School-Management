...
urlpatterns = [
    ...
    path('adminregister/',include('adminregister.urls')),
    path('teacherprofile/',include('teacherprofile.urls')),
    path('studentprofile/',include('studentprofile.urls')),
     path('save-profile-picture/', views.save_profile_picture, name='save-profile-picture'),
]
